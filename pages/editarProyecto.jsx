...
import { ArrowBackIosTwoTone, BorderAllSharp } from '@mui/icons-material';
...
import style from './editarProyect.module.css';
...
style={{ top: '25px', fontSize:33, left:'15px', position:'absolute', color: '#8ACBB5', border: '1px solid #272C41',borderRadius:'20px'}}
 />
      <h1 className={styles.h2title}>Editar Proyecto</h1>
